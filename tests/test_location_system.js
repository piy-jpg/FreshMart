...
async function runTests() {
  ...
  for (const page of pages) {
    const candidatePath1 = path.join(__dirname, '..', 'frontend', 'customer-store', page);
    const candidatePath2 = path.join(__dirname, '..', page);
    const targetPath = fs.existsSync(candidatePath1) ? candidatePath1 : candidatePath2;
