  ...
  getInventoryLedger() {
    ...
    return products.map(p => {
      ...
      return {
        ...
        customerReservedStock: reservedStock,
        manualReservedStock: Number(p.manualReservedStock || p.manual_reserved_stock || 0),
        reservedStock: reservedStock + Number(p.manualReservedStock || p.manual_reserved_stock || 0),
        availableStock: Math.max(0, currentStock - reservedStock - Number(p.manualReservedStock || p.manual_reserved_stock || 0)),
